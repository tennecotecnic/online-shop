...
public class UserInMemoryRepository {
    ...
    public UserInMemoryRepository() {
        dataBase.put(1, new User(1));
        dataBase.put(2, new User(2));
        dataBase.put(3, new User(3));
        dataBase.put(4, new User(4));
        dataBase.put(5, new User(5));
        dataBase.put(6, new User(6));
        dataBase.put(7, new User(7));
        dataBase.put(8, new User(8));
        dataBase.put(9, new User(9));
        dataBase.put(10, new User(10));
    }
